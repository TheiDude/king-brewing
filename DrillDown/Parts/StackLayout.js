    ...
    for (var i=0; i<kids.length; i++) {
        if (kids[i].nodeType == Node.ELEMENT_NODE) {
            ...
            if (!this._inDesign) {
                ...
                // The StackLayout is most likely to have transitions. Prepare the subview to have layers by using an identity matrix. This will improve performance.
                view.style.webkitTransform = 'translate(0px, 0px)';
            }
        }
    }
