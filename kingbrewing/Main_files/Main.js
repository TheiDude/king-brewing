IMpreload('Main_files', 'shapeimage_2', '0');
IMpreload('Main_files', 'shapeimage_2', '1');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id1", "Main_files/transparent.gif");
    fixupIEPNG("id3", "Main_files/transparent.gif");
    fixupIEPNG("id4", "Main_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_0", "Main_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_1", "Main_files/transparent.gif");
    fixupIEPNG("shapeimage_2", "Main_files/transparent.gif");
    fixupIEPNG("id6", "Main_files/transparent.gif");
    fixupIEPNG("id7", "Main_files/transparent.gif");
    return true;
}
